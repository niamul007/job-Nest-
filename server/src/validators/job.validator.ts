...
export const createJobSchema = z.object({
    ...
    description: z.string().min(10, "Description must be at least 10 characters long").max(5000, "Description must be less than 1000 characters long"),
    ...
    salary_min: z.coerce.number().min(0, "Minimum salary must be a positive number").optional(),
    salary_max: z.coerce.number().min(0, "Maximum salary must be a positive number").optional(),
})